...
public class AlarmListActivity extends Activity implements OnClickListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		mReceiver = new BroadcastReceiver()
		{
			...
			public void onReceive(Context context, Intent intent)
			{
				...
				mAlarmListAdapter.mAlarmList = db.getAlarms();
				mAlarmListAdapter.notifyDataSetChanged();
				Log.d("rae", "更新闹钟列表");
			}
			
		};
		registerReceiver(mReceiver, new IntentFilter("com.yixin.nfyh.cloud.action.pullmessage"));
	}
	...
	private void init()
	{
		...
		db = AlarmProviderFactory.getDbAlarm(this);
