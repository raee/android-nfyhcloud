...
public class AddGanyuActivity extends BaseActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		View view = getLayoutInflater().inflate(R.layout.fm_ptinfo_ganyu_add, null);
		setContentView(view);
		showHomeAsUp();
		...
		view.findViewById(R.id.ll_ptinfo_ganyu_add_sign).setOnClickListener(this);
		view.findViewById(R.id.ll_ptinfo_ganyu_add_date).setOnClickListener(this);
		mSignTypeNameTextView = (TextView) view.findViewById(R.id.tv_ptinfo_ganyu_add_sign_name);
		mSignDateTextView = (TextView) view.findViewById(R.id.tv_ptinfo_ganyu_add_sign_date);
