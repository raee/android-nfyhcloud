		...
		OnCheckedChangeListener
{
	...
	public void onClick(View v)
	{
		...
		switch (v.getId())
		{
			...
			case R.id.ll_setting_desktop:// 桌面呼救
				...
				startActivity(intent);
				break;
			case R.id.ll_setting_version:// 检查新版本
	...
	// switch (msg.what)
	// {
	// case CheckVersionService.STATUS_DOWN_NEW_VERSION:
	// showMsg("检测有新版，正在下载...");
	// tvAppVersion
	// .setText("正在下载新版本");
	// break;
	// case CheckVersionService.STATUS_DOWN_NO_VERSION:
	// showMsg("现在已经是最新版本了！");
	// break;
	// case CheckVersionService.STATUS_DOWN_FAILD:
	// showMsg("新版本下载失败，请检查网络连接。");
	// break;
	// case CheckVersionService.STATUS_DOWN_DONE:
	// break;
	// default:
	// break;
	// }
