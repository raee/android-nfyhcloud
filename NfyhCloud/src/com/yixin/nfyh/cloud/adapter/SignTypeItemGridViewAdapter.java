...
public class SignTypeItemGridViewAdapter extends SignTypeItemBaseAdapterView {
	...
	public SignTypeItemGridViewAdapter(Activity context) {
		super(context);
	...
	public View getView(int location, View v, ViewGroup vg) {
		...
		if (v == null) {
			View signView = LayoutInflater.from(this.context).inflate(R.layout.ui_sign_detail_item, null);
			TextView tvValue = (TextView) signView.findViewById(R.id.tv_ui_sign_detail_subtitle);
			
			TextView tvTitle = (TextView) signView.findViewById(R.id.tv_ui_sign_detail_title);
			TextView tvUnit = (TextView) signView.findViewById(R.id.tv_ui_sign_detail_unit);
			ImageView imgRight = (ImageView) signView.findViewById(R.id.img_ui_sign_detail_right);
			if (m.getIsSign() == 1) {
	...
	public void setValue(int postion, String value) {
		...
		try {
			TextView tvValue = (TextView) this.viewList.get(postion).findViewById(R.id.tv_ui_sign_detail_subtitle);
