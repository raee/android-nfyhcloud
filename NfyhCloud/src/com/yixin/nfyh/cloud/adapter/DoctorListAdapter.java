...
public class DoctorListAdapter extends BaseListAdapter<Users>
{
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id)
	{
		...
		{
			RongIM.getInstance().startPrivateChat(getContext(), m.getUid(), m.getName());
		}
	}
	...
	public void fillViewData(AdapterViewHolder absHolder, Users m)
	{
		...
		ImageLoader.getInstance().displayImage(m.getHeadImage(), holder.mPtHead,new ImageLoadingListener()
		{
			...
			{
				// 设置默认的头像
				holder.mPtHead.setImageResource(R.drawable.user_default_header);
			}
	...
	public AdapterViewHolder getViewHolder(View convertView)
	{
		...
		holder.mPtName = (TextView) convertView.findViewById(R.id.tv_ptinfo_name);
		holder.mPtHead = (ImageView) convertView.findViewById(R.id.img_ptinfo_head);
		//		holder.mDongtai = (TextView) convertView.findViewById(R.id.tv_ptinfo_desc);
		//		holder.mDongtaiDate = (TextView) convertView.findViewById(R.id.tv_ptinfo_date);
		return holder;
	}
