...
public abstract class SignTypeItemBaseAdapterView extends BaseAdapter
{
	...
	public SignTypeItemBaseAdapterView(Activity context, List<SignTypes> datas)
			throws SQLException
	{
		...
		{
			UserSigns usersign = apiSign.getLastUserSignsByType(user.getUid(),
					itemSignTypes); //获取最近一次的数据
