...
public class Account implements SoapConnectionCallback<Users>
{
	...
	public void onSoapConnectSuccess(final Users data)
	{
		...
		// 登录融云
		RaeRongCloudIM.getInstance().login(data.getAppSecret(), data.getUid(), data.getName(), data.getHeadImage(), new IMLoginListener()
		{
			...
			public void onSuccess(String token)
			{
				...
				RongIM.setUserInfoProvider(new NfyhUserProvider(mContext), true); // 用户提供者
			...
			@Override
			public void onIMLoginSuccess(String userName, String password, String extra)
			{
				
			}
			
			@Override
			public void onIMLoginError(String userName, String password, int errorCode, String msg)
			{
