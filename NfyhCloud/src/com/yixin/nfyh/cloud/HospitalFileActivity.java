...
public class HospitalFileActivity extends BaseActivity
{
	...
	public void onClick(View v)
	{
		switch (v.getId())
		{
			case R.id.ll_menu_yhzp:
				startActivity(new Intent(this, PhotoActivity.class));
				break;
			case R.id.ll_menu_xxts:
				startActivity(new Intent(this, MessageActivity.class));
				break;
			case R.id.ll_menu_jkpg:
				
				Intent jkpgIntent = new Intent(this, WebViewerActivity.class);
				Uri uri = Uri.parse(getResources().getString(
						R.string.url_health_assess));
				jkpgIntent.setData(uri);
				jkpgIntent.putExtra(WebViewerActivity.EXTRA_COOKIE,
						getSetting().getUser().getCookie());
