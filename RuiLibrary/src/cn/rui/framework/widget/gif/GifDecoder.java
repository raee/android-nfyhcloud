package cn.rui.framework.widget.gif;
...
public class GifDecoder extends Thread
{
	...
	public int					width;									// full
																		// image
																		// width
	public int					height;								// full
																		// image
																		// height
	private boolean				gctFlag;								// global
																		// color
																		// table
																		// used
	private int					gctSize;								// size
																		// of
																		// global
																		// color
																		// table
	private int					loopCount			= 1;				// iterations;
																		// 0 =
																		// repeat
																		// forever

	private int[]				gct;									// global
																		// color
																		// table
	private int[]				lct;									// local
																		// color
																		// table
	private int[]				act;									// active
																		// color
																		// table

	private int					bgIndex;								// background
																		// color
																		// index
	private int					bgColor;								// background
																		// color
	private int					lastBgColor;							// previous
																		// bg
																		// color
//	private int					pixelAspect;							// pixel
																		// aspect
																		// ratio

	private boolean				lctFlag;								// local
																		// color
																		// table
																		// flag
	private boolean				interlace;								// interlace
																		// flag
	private int					lctSize;								// local
																		// color
																		// table
																		// size

	private int					ix, iy, iw, ih;						// current
																		// image
																		// rectangle
	private int					lrx, lry, lrw, lrh;
	private Bitmap				image;									// current
																		// frame
	private Bitmap				lastImage;								// previous
																		// frame
	private GifFrame			currentFrame		= null;

	private boolean				isShow				= false;

	private byte[]				block				= new byte[256];	// current
																		// data
																		// block
	private int					blockSize			= 0;				// block
																		// size
	...
	private boolean				transparency		= false;			// use
																		// transparent
																		// color
	private int					delay				= 0;				// delay
																		// in
																		// milliseconds
	private int					transIndex;							// transparent
																		// color
																		// index
	...
	private GifFrame			gifFrame;								// frames
																		// read
																		// from
																		// current
																		// file
